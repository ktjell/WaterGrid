...
#            data = data
    ...
    # Find minimum using Legendre Comparison:
            ...
            output2 = input_shares[0] - output6   # cons 3 2
            output3 = input_shares[1] - output6  # cons 4 3
                        
            output5 = input_shares[2] - output6 - output4 # cons 1 5
            output1 = input_shares[3] - output6 - output4 # cons 2 6 
